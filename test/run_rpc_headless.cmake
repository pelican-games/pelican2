...
function(validate_rpc_stdout stdout label)
    ...
    if(NOT line0 MATCHES [=["id":1]=] OR NOT line0 MATCHES [=["instance_id":"[0-9a-fA-F-]+"]=] OR NOT line0 MATCHES [=["project_root"]=] OR NOT line0 MATCHES [=["scene":"default_scene"]=] OR NOT line0 MATCHES [=["frame":0]=] OR NOT line0 MATCHES [=["time":0\.0]=])
    ...
    if(NOT line9 MATCHES [=["id":10]=] OR NOT line9 MATCHES [=["instance_id":"[0-9a-fA-F-]+"]=] OR NOT line9 MATCHES [=["scene":"default_scene"]=] OR NOT line9 MATCHES [=["frame":1]=])
