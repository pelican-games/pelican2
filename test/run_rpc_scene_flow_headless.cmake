...
configure_file(
    "${source_root}/test/fixtures/hybrid_sky_rendering_config.json"
    "${OUT_DIR}/project/passes/main_rendering_config.json"
    COPYONLY)
...
"{\"jsonrpc\":\"2.0\",\"id\":3,\"method\":\"update_transforms\",\"params\":{\"objects\":[\"transient\"],\"transforms\":[{\"pos\":[3.0,0.0,0.0],\"rotation\":[0.0,0.0,0.0,1.0],\"scale\":[0.7,0.7,0.7]}]}}\n"
...
"{\"jsonrpc\":\"2.0\",\"id\":10,\"method\":\"update_transforms\",\"params\":{\"objects\":[\"transient\"],\"transforms\":[{\"pos\":[3.0,0.0,0.0],\"rotation\":[0.0,0.0,0.0,1.0],\"scale\":[0.7,0.7,0.7]}]}}\n"
...
function(validate_stdout stdout label)
    ...
    if(NOT line0 MATCHES [=["startup":\{]=] OR NOT line0 MATCHES [=["complete":true]=])
        message(FATAL_ERROR "${label}: initial get_status did not include a complete startup report:\n${line0}")
    endif()
