...
| [design_material_shading.md](../design_material_shading.md) | ✅ M1〜M3.5(WP58/68/70/76/78/80/83) + stable material tag selection(WP206a) + pass-local named variant(WP206b)。spv-link は experimental | [第6章](06_rendering.md) |
