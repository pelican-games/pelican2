...
3. **設定合成** — [`basicconfig.cpp` 内](../../src/core/loader/basicconfig.cpp#L296) `validateProjectJson`(schema/version の hard error ゲート)→ CLI > project.json > [default_config.json](../../src/core/resources/default_config.json) の 3 段合成
...
|---|---|---|
| `project.json` | [第3章](03_project_format.md) | [loader/basicconfig.cpp](../../src/core/loader/basicconfig.cpp#L296) `validateProjectJson` |
