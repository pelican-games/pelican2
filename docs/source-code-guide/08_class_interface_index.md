...
| tagged union | [`PassInfo`](../../src/core/renderingpass/renderingpass.hpp#L316) | 閉じた種類集合を `std::variant` と `visit`/type test で dispatch |
...
| `Camera` | module/state | [`camera.hpp`](../../src/core/renderer/camera.hpp#L17) | [`Camera::Camera()`](../../src/core/renderer/camera.cpp#L540) | projection/view、scene camera、orbit/follow/fly controller、[`discontinuityRevision()`](../../src/core/renderer/camera.hpp#L104) |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `Renderer` | module/orchestrator | [`renderer.hpp`](../../src/core/vkcore/renderer.hpp#L87) | [`renderLogicalFrame()`](../../src/core/vkcore/renderer.cpp#L4258) / [`render()`](../../src/core/vkcore/renderer.cpp#L5181) | hot reload、graph variant、logical frame(multi-view)、trace を束ねる |
...
| `CompiledRenderingPass` | bound value | [`renderingpass.hpp`](../../src/core/renderingpass/renderingpass.hpp#L197) | [`compileRenderingPassRuntime()`](../../src/core/renderingpass/renderingpassruntimecompiler.cpp#L2447) | pass/task definition と登録済み runtime ID の集合 |
...
| `FrameGraphDefinition` | pure graph | [`frameplanner.hpp`](../../src/core/renderingpass/frameplanner.hpp#L116) | [`parseFrameGraphDefinitionsFromConfigJson()`](../../src/core/renderingpass/frameplanner.cpp#L1626) | node declarations と既知 resource |
| `FramePlan` | planner output | [`frameplanner.hpp`](../../src/core/renderingpass/frameplanner.hpp#L59) | [`planFrameGraph()`](../../src/core/renderingpass/frameplanner.cpp#L1677) | stable order、levels、RAW barriers |
...
| `FrameGraphResourceContainer` | module/GPU owner | [`computetask.hpp`](../../src/core/renderingpass/computetask.hpp#L74) | [`registerBuffers()`](../../src/core/renderingpass/computetask.cpp#L1834) | named storage buffers と descriptor info |
| `ComputeTaskContainer` | module/runtime registry | [`computetask.hpp`](../../src/core/renderingpass/computetask.hpp#L93) | [`registerComputeTask()`](../../src/core/renderingpass/computetask.cpp#L2379) | compute pipeline、descriptor、dispatch group、barrier |
...
| `ShaderLibrary` | module/registry | [`ShaderLibrary`](../../src/core/shader/shaderlibrary.hpp#L118) | [`load/reload`](../../src/core/shader/shaderlibrary.cpp#L362) | module + reflection + source/version/log の [`ShaderBundle`](../../src/core/shader/shaderlibrary.hpp#L30) 管理 |
...
| `RenderTiming` | optional module | [`rendertiming.hpp`](../../src/core/vkcore/rendertiming.hpp#L115) | [`rendertiming.cpp`](../../src/core/vkcore/rendertiming.cpp#L1) | timestamp query と node/view ごとの GPU timing |
