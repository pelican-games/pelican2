...
| `SceneLoader` | module/runtime binder | [`scene.hpp`](../../src/core/loader/scene.hpp#L38) | [`load()`](../../src/core/loader/scene.cpp#L288) | scene clear/load、object name↔Entity、camera/light/model/collider/behavior binding、transient glTF |
...
| `Camera` | module/state | [`camera.hpp`](../../src/core/renderer/camera.hpp#L19) | [`Camera::Camera()`](../../src/core/renderer/camera.cpp#L319) | projection/view、scene camera、orbit/follow/fly controller、[`discontinuityRevision()`](../../src/core/renderer/camera.hpp#L106) |
...
| `EditorCommandService` | typed 編集サービス | [`editorcommandservice.hpp`](../../src/core/communication/editorcommandservice.hpp#L227) | [`editorcommandservice.cpp`](../../src/core/communication/editorcommandservice.cpp) | 全編集 RPC の実体 |
| `EditorCommandRpcAdapter` / `EditorCommandImGuiFakeAdapter` | adapter | [`EditorCommandRpcAdapter`](../../src/core/communication/editorcommandservice.hpp#L307) / [`EditorCommandImGuiFakeAdapter`](../../src/core/communication/editorcommandservice.hpp#L361) | 同左 | RPC と ImGui が **同じサービス**を呼ぶことの担保 |
...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L38) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L131) | central workspace、embedded viewport、7 dock、選択／gizmo model と Outliner / Inspector、frame plan、fullscreen pass JSON 下書き、保存、bounded engine log 表示を所有 |
