...
| `EngineLaunchConfig` | module | [`launchconfig.hpp`](../../src/core/launchconfig.hpp#L19) | [`player main` で設定](../../src/player/main.cpp#L471) | headless、RPC、XR mode、game logic DLL、record/replay など起動時値 |
...
| `RenderFeatureComposeResult` | pure transformation result | [`featurecompose.hpp`](../../src/project/featurecompose.hpp#L16) | [`composeRenderFeatureConfig()`](../../src/project/featurecompose.cpp#L2636) | base rendering JSON に feature fragment を順序付き合成 |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `Renderer` | module/orchestrator | [`renderer.hpp`](../../src/core/vkcore/renderer.hpp#L69) | [`renderLogicalFrame()`](../../src/core/vkcore/renderer.cpp#L4015) / [`render()`](../../src/core/vkcore/renderer.cpp#L4938) | hot reload、graph variant、logical frame(multi-view)、trace を束ねる |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `VulkanManageCore` | module/low-level owner | [`core.hpp`](../../src/core/vkcore/core.hpp#L35) | [`constructor`](../../src/core/vkcore/core.cpp#L788) | instance、device、queues、command pools、VMA(Vulkan Memory Allocator — GPU メモリの確保と suballocation を肩代わりする外部ライブラリ) allocation、[`getDebugUtils()`](../../src/core/vkcore/core.hpp#L101) / [`setCurrentFrameIndex()`](../../src/core/vkcore/core.hpp#L129)。XR 時は bootstrap 経由 |
...
| `BufferWrapper` / `ImageWrapper` | RAII value | [`buf.hpp`](../../src/core/vkcore/buf.hpp#L7) / [`image.hpp`](../../src/core/vkcore/image.hpp#L8) | [`VulkanManageCore::allocBuf()`](../../src/core/vkcore/core.cpp#L1172) | Vulkan object と VMA allocation を同居させる |
...
| `EmbeddedViewport` | Qt viewport panel | [`embeddedviewport.hpp`](../../src/devstudio/viewport/embeddedviewport.hpp#L23) | [`embeddedviewport.cpp`](../../src/devstudio/viewport/embeddedviewport.cpp) | project と player lifecycle、window discovery、physical-pixel pointer gesture、pick/editor RPC transport、resize/focus/crash UI を所有。選択と gizmo 状態は中央 model が所有 |
