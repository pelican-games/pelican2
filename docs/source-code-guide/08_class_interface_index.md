...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `Renderer` | module/orchestrator | [`renderer.hpp`](../../src/core/vkcore/renderer.hpp#L69) | [`renderLogicalFrame()`](../../src/core/vkcore/renderer.cpp#L4016) / [`render()`](../../src/core/vkcore/renderer.cpp#L4939) | hot reload、graph variant、logical frame(multi-view)、trace を束ねる |
