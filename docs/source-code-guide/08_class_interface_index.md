...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L21) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L72) | central workspace、embedded viewport、5 dock、panel/layout menu、bounded engine log 表示を所有 |
| `EmbeddedViewport` | Qt viewport panel | [`embeddedviewport.hpp`](../../src/devstudio/viewport/embeddedviewport.hpp#L16) | [`embeddedviewport.cpp`](../../src/devstudio/viewport/embeddedviewport.cpp) | player lifecycle、window discovery、trailing-edge resize debounce、黒背景消去、focus、crash/restart UI と未切り詰め output signal を所有 |
