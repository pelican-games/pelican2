...
| `...Codec` | authored ↔ canonical ↔ runtime の双方向変換関数表 | [`ComponentCodec`](../../src/core/loader/componentcodec.hpp#L115) は 5 点セットが必須 |
...
| `gameLogicAbiVersion` / `initializeConfiguredGameLogic()` | game DLL 境界 | [`gamelogic.hpp`](../../src/core/userpublic/gamelogic.hpp#L8) | [`gamelogicreload.cpp`](../../src/core/gamelogic/gamelogicreload.cpp#L376) | game DLL(`pelican_game_logic`)の ABI 契約とロード・ホットリロード |
...
| `ProjectBasicConfig` | module/value binding | [`basicconfig.hpp`](../../src/core/loader/basicconfig.hpp#L11) | [`constructor`](../../src/core/loader/basicconfig.cpp#L462) | engine default と project JSON を merge し型付き accessor を提供 |
...
| `SceneLoader` | module/runtime binder | [`scene.hpp`](../../src/core/loader/scene.hpp#L38) | [`load()`](../../src/core/loader/scene.cpp#L290) | scene clear/load、object name↔Entity、camera/light/model/collider/behavior binding、transient glTF |
| `AuthoringSceneDocument` | 版付きドキュメント | [`authoringscenedocument.hpp`](../../src/core/loader/authoringscenedocument.hpp#L90) | [`authoringscenedocument.cpp`](../../src/core/loader/authoringscenedocument.cpp) | scene v1 の権威表現。`SceneRevision` とセッション安定な `AuthoringObjectId` を発行 |
...
| `ComponentCodec` | 5 点セットの関数表 | [`componentcodec.hpp`](../../src/core/loader/componentcodec.hpp#L115) | [`componentcodec.cpp`](../../src/core/loader/componentcodec.cpp) | authored ↔ canonical ↔ runtime。`ComponentCodecRuntimeKind`([`ComponentCodecRuntimeKind`](../../src/core/loader/componentcodec.hpp#L19))が runtime target 型を決める |
| `SceneSaveErrorCode` / `SceneSaveError` / `SceneSaveResult` | 保存契約 | [`SceneSaveErrorCode`](../../src/core/loader/basicconfig.hpp#L19) / [`SceneSaveError`](../../src/core/loader/basicconfig.hpp#L25) / [`SceneSaveResult`](../../src/core/loader/basicconfig.hpp#L48) | [`saveSceneDocument()`](../../src/core/loader/basicconfig.cpp#L691) | `ExternalModification` / `Unavailable` / `IoFailure` の型付き保存エラー |
...
| `ModelTemplate` | value graph | [`ModelTemplate`](../../src/core/model/modeltemplate.hpp#L109) | [`gltf load`](../../src/core/model/gltf.cpp#L1) | primitive range、material、skin/VAT metadata を持つ再配置可能 model 定義 |
...
| `RenderFeatureComposeResult` | pure transformation result | [`featurecompose.hpp`](../../src/project/featurecompose.hpp#L16) | [`composeRenderFeatureConfig()`](../../src/project/featurecompose.cpp#L2695) | base rendering JSON に feature fragment を順序付き合成 |
...
| `BehaviorAttachmentArena` | module | [`behaviorarena.hpp`](../../src/core/gamelogic/behaviorarena.hpp#L110) | [`behaviorarena.cpp`](../../src/core/gamelogic/behaviorarena.cpp) | 生存・初期化・イベント配送・遅延構造変更・owner 解放 |
...
| `Camera` | module/state | [`camera.hpp`](../../src/core/renderer/camera.hpp#L19) | [`Camera::Camera()`](../../src/core/renderer/camera.cpp#L199) | projection/view、scene camera、orbit/follow/fly controller、[`discontinuityRevision()`](../../src/core/renderer/camera.hpp#L106) |
...
| `PassDefinition` | pure definition | [`renderingpass.hpp`](../../src/core/renderingpass/renderingpass.hpp#L119) | JSON parser 群 | target、input、load/store、clear、`PassInfo` variant |
| `CompiledRenderingPass` | bound value | [`renderingpass.hpp`](../../src/core/renderingpass/renderingpass.hpp#L197) | [`compileRenderingPassRuntime()`](../../src/core/renderingpass/renderingpassruntimecompiler.cpp#L2470) | pass/task definition と登録済み runtime ID の集合 |
...
| `FrameGraphDefinition` | pure graph | [`frameplanner.hpp`](../../src/core/renderingpass/frameplanner.hpp#L116) | [`parseFrameGraphDefinitionsFromConfigJson()`](../../src/core/renderingpass/frameplanner.cpp#L1707) | node declarations と既知 resource |
| `FramePlan` | planner output | [`frameplanner.hpp`](../../src/core/renderingpass/frameplanner.hpp#L59) | [`planFrameGraph()`](../../src/core/renderingpass/frameplanner.cpp#L1758) | stable order、levels、RAW barriers |
| `FrameGraphRuntimeContainer` | module/binder | [`framegraphruntime.hpp`](../../src/core/renderingpass/framegraphruntime.hpp#L172) | [`registerExecutionPlan()`](../../src/core/renderingpass/framegraphruntime.cpp#L575) | plan の node 名を compiled pass/task index へ bind |
| `RenderTargetContainer` | module/GPU owner | [`rendertargetcontainer.hpp`](../../src/core/renderingpass/rendertargetcontainer.hpp#L14) | [`registerRenderTarget()`](../../src/core/renderingpass/rendertargetcontainer.cpp#L409) | named offscreen image/view、extent metadata、resize recreate |
...
| `FrameGraphResourceContainer` | module/GPU owner | [`computetask.hpp`](../../src/core/renderingpass/computetask.hpp#L74) | [`registerBuffers()`](../../src/core/renderingpass/computetask.cpp#L1875) | named storage buffers と descriptor info |
| `ComputeTaskContainer` | module/runtime registry | [`computetask.hpp`](../../src/core/renderingpass/computetask.hpp#L93) | [`registerComputeTask()`](../../src/core/renderingpass/computetask.cpp#L2420) | compute pipeline、descriptor、dispatch group、barrier |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `VulkanManageCore` | module/low-level owner | [`core.hpp`](../../src/core/vkcore/core.hpp#L36) | [`constructor`](../../src/core/vkcore/core.cpp#L835) | instance、device、queues、command pools、VMA(Vulkan Memory Allocator — GPU メモリの確保と suballocation を肩代わりする外部ライブラリ) allocation、[`getDebugUtils()`](../../src/core/vkcore/core.hpp#L103) / [`setCurrentFrameIndex()`](../../src/core/vkcore/core.hpp#L134)。XR 時は bootstrap 経由 |
...
| `BufferWrapper` / `ImageWrapper` | RAII value | [`buf.hpp`](../../src/core/vkcore/buf.hpp#L7) / [`image.hpp`](../../src/core/vkcore/image.hpp#L8) | [`VulkanManageCore::allocBuf()`](../../src/core/vkcore/core.cpp#L1233) | Vulkan object と VMA allocation を同居させる |
...
| `ShaderLibrary` | module/registry | [`ShaderLibrary`](../../src/core/shader/shaderlibrary.hpp#L118) | [`load/reload`](../../src/core/shader/shaderlibrary.cpp#L372) | module + reflection + source/version/log の [`ShaderBundle`](../../src/core/shader/shaderlibrary.hpp#L30) 管理 |
| `PipelineFactory` | module/factory+registry | [`pipelinefactory.hpp`](../../src/core/shader/pipelinefactory.hpp#L59) | [`buildGraphicsPipeline()`](../../src/core/shader/pipelinefactory.cpp#L742) | reflection-driven layout、graphics/compute pipeline、cache、hot rebuild |
...
| `VertBufContainer` | module/GPU owner | [`vertbufcontainer.hpp`](../../src/core/model/vertbufcontainer.hpp#L40) | [`addPrimitiveEntry()`](../../src/core/model/vertbufcontainer.cpp#L507) | shared vertex/index/skinning buffers と primitive ranges |
| `MaterialContainer` | module/GPU owner | [`materialcontainer.hpp`](../../src/core/material/materialcontainer.hpp#L34) | [`registerMaterial()`](../../src/core/material/materialcontainer.cpp#L1850) | texture、material descriptor/pipeline、push constants |
| `PolygonInstanceContainer` | module/GPU owner | [`polygoninstancecontainer.hpp`](../../src/core/renderer/polygoninstancecontainer.hpp#L224) | [`preflightModelInstance()`](../../src/core/renderer/polygoninstancecontainer.hpp#L336) → [`stageModelInstance()`](../../src/core/renderer/polygoninstancecontainer.hpp#L337) → [`publishModelInstance()`](../../src/core/renderer/polygoninstancecontainer.hpp#L340) | SlotMap 化(slot map — 添字で直接引ける配列に「空き枠リスト」と枠ごとの世代番号を添えたコンテナ。削除した枠は再利用し、古いハンドルは世代の不一致で弾きます)された instance lifecycle、model matrix buffer、indirect draw command。`removeModelInstance()` は `bool` を返す |
...
| `StagedModelInstance` | 未公開候補 | [`polygoninstancecontainer.hpp`](../../src/core/renderer/polygoninstancecontainer.hpp#L206) | 同左 | 全割り当て済みの CPU 候補。`publishModelInstance()` が唯一の no-fail 公開点 |
...
| `GpuTimingSubrange` / `GpuTimingSampleIdentity` / `makeGpuTimingSampleLabel()` | GPU timing | [`GpuTimingSubrange`](../../src/core/vkcore/rendertiming.hpp#L27) / [`body_supported` メンバ](../../src/core/vkcore/rendertiming.hpp#L44) / [`makeGpuTimingSampleLabel()`](../../src/core/vkcore/rendertiming.hpp#L147) | [`rendertiming.cpp`](../../src/core/vkcore/rendertiming.cpp) | view 分離 + `barriers`/`body` 分割。ラベルは debug utils と同一命名 |
...
| `LightContainer` | module/GPU owner | [`lightcontainer.hpp`](../../src/core/light/lightcontainer.hpp#L26) | [`load()`](../../src/core/light/lightcontainer.cpp#L316) | directional/point/spot light、shadow VP、GPU light buffer |
...
| `RenderTiming` | optional module | [`rendertiming.hpp`](../../src/core/vkcore/rendertiming.hpp#L151) | [`rendertiming.cpp`](../../src/core/vkcore/rendertiming.cpp#L1) | timestamp query と node/view ごとの GPU timing |
...
| engine RPC handlers | free registration function | [`runEngineRpcServer()`](../../src/core/communication/rpcserver.cpp#L1847) | 同左 | `setHandler()` に渡す一意な公開 method 文字列を 1 件と数え、57 protocol method(実行制御・診断 28 + 編集 29)を module/GameContext/編集サービスへ bind |
| `EditorCommandService` | typed 編集サービス | [`editorcommandservice.hpp`](../../src/core/communication/editorcommandservice.hpp#L228) | [`editorcommandservice.cpp`](../../src/core/communication/editorcommandservice.cpp) | 全編集 RPC の実体 |
| `EditorCommandRpcAdapter` / `EditorCommandImGuiFakeAdapter` | adapter | [`EditorCommandRpcAdapter`](../../src/core/communication/editorcommandservice.hpp#L306) / [`EditorCommandImGuiFakeAdapter`](../../src/core/communication/editorcommandservice.hpp#L360) | 同左 | RPC と ImGui が **同じサービス**を呼ぶことの担保 |
...
| `EditorActorId` / `EditorWatchToken` / `EditorJournalRecord` | 同時編集の値 | [`EditorActorId()`](../../src/core/communication/editorjournal.hpp#L18) / [`EditorWatchToken`](../../src/core/communication/editorcommandservice.hpp#L181) / [`EditorJournalRecord`](../../src/core/communication/editorjournal.hpp#L89) | 同左 | actor 単位 undo と `SceneRevision` による CAS(compare-and-swap — 「自分が見た版が今も最新か」を確かめ、一致するときだけ書き換える方式。ずれていれば `stale_revision` で弾きます) |
| `makeEditorRuntimeService()` | factory | [`makeEditorRuntimeService()`](../../src/core/communication/editorruntimefactory.hpp#L32) | [`editorruntimefactory.cpp`](../../src/core/communication/editorruntimefactory.cpp) | production で編集面を組み立てる唯一の composition |
...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L38) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L134) | central workspace、embedded viewport、7 dock、選択／gizmo model と Outliner / Inspector、frame plan、fullscreen pass JSON 下書き、保存、bounded engine log 表示を所有 |
| `FullscreenPassWidget` | draft-only Qt form | [`fullscreenpasswidget.hpp`](../../src/devstudio/view/fullscreenpasswidget.hpp#L19) | [`fullscreenpasswidget.cpp`](../../src/devstudio/view/fullscreenpasswidget.cpp) | frame-plan resource 候補と read-only 著作宣言から `fullscreen` の部分 JSON、omitted keys、三値の検査軸を表示。project write と engine apply は持たない |
| `EmbeddedViewport` | Qt viewport panel | [`embeddedviewport.hpp`](../../src/devstudio/viewport/embeddedviewport.hpp#L28) | [`embeddedviewport.cpp`](../../src/devstudio/viewport/embeddedviewport.cpp) | project と player lifecycle、window discovery、physical-pixel pointer gesture、pick/editor RPC transport、resize/focus/crash UI を所有。選択と gizmo 状態は中央 model が所有 |
...
| `NativeWindowHost` | Win32 foreign-window adapter | [`NativeWindowHost`](../../src/devstudio/viewport/nativewindowhost.hpp#L33) | [`nativewindowhost.cpp`](../../src/devstudio/viewport/nativewindowhost.cpp) | HWND の style/parent/physical extent/focus/diagnostics だけを担当 |
...
| `ProjectOutlinerModel` | 読み取り専用 project/scene model | [`ProjectOutlinerModel`](../../src/devstudio/model/project.hpp#L37) | [`project.cpp`](../../src/devstudio/model/project.cpp) | `pelican_project` だけで project を開き、`(scene_id, declaration_index)` identity の scene/object 木を構築 |
...
| `InspectorModel` | view-independent editor RPC client | [`InspectorModel`](../../src/devstudio/model/inspectormodel.hpp) | [`inspectormodel.cpp`](../../src/devstudio/model/inspectormodel.cpp) | declaration identity 解決、schema-driven widget plan、watch/refresh guard、edit/preview/undo/redo/save の terminal result を管理 |
...
| `FramePlanModel` | view-independent frame-plan projection | [`FramePlanModel`](../../src/devstudio/model/frameplanmodel.hpp) | [`buildFramePlanModel()`](../../src/devstudio/model/frameplanmodel.cpp) | `get_frame_plan` v1 を順序付き node、resource、barrier、attachment ops、material route へ縮約し、低レベル raw plan を保持しない |
| `FramePlanWidget` | Qt read-only frame-plan panel | [`FramePlanWidget`](../../src/devstudio/view/frameplanwidget.hpp) | [`frameplanwidget.cpp`](../../src/devstudio/view/frameplanwidget.cpp) | 接続時1回 + 手動 refresh、折りたたみ tree / filter、player 未起動・RPC 失敗の明示状態を所有 |
