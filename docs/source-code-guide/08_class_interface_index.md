...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L31) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L100) | central workspace、embedded viewport、6 dock、選択 model と Outliner / Inspector、frame plan、bounded engine log 表示を所有 |
