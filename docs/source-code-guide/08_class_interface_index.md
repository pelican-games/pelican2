...
| `MaterialContainer` | module/GPU owner | [`materialcontainer.hpp`](../../src/core/material/materialcontainer.hpp#L34) | [`registerMaterial()`](../../src/core/material/materialcontainer.cpp#L1799) | texture、material descriptor/pipeline、push constants |
...
| `EmbeddedViewport` | Qt viewport panel | [`embeddedviewport.hpp`](../../src/devstudio/viewport/embeddedviewport.hpp#L16) | [`embeddedviewport.cpp`](../../src/devstudio/viewport/embeddedviewport.cpp) | player lifecycle、window discovery、trailing-edge resize debounce、黒背景消去、focus、crash/restart UI を所有 |
| `EngineProcess` | Qt child-process owner | [`EngineProcess`](../../src/devstudio/viewport/engineprocess.hpp#L20) | [`engineprocess.cpp`](../../src/devstudio/viewport/engineprocess.cpp) | `pelican_player` の非同期起動、出力、終了監視と Windows kill-on-close job を所有。renderer へはリンクしない |
