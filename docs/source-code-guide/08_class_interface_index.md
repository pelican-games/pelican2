...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L37) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L130) | central workspace、embedded viewport、7 dock、選択／gizmo model と Outliner / Inspector、frame plan、fullscreen pass JSON 下書き、保存、bounded engine log 表示を所有 |
