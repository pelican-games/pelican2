...
| abstract interface | [`IFrameTarget`](../../src/core/vkcore/frametarget.hpp#L254)、[`ILogicalFrameTarget`](../../src/core/vkcore/renderer.hpp#L62) | window swapchain と headless target、flat と XR composition を virtual dispatch で交換 |
...
| `RenderFeatureComposeResult` | pure transformation result | [`featurecompose.hpp`](../../src/project/featurecompose.hpp#L16) | [`composeRenderFeatureConfig()`](../../src/project/featurecompose.cpp#L2674) | base rendering JSON に feature fragment を順序付き合成 |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `Renderer` | module/orchestrator | [`renderer.hpp`](../../src/core/vkcore/renderer.hpp#L69) | [`renderLogicalFrame()`](../../src/core/vkcore/renderer.cpp#L4054) / [`render()`](../../src/core/vkcore/renderer.cpp#L4977) | hot reload、graph variant、logical frame(multi-view)、trace を束ねる |
...
| `FrameGraphDefinition` | pure graph | [`frameplanner.hpp`](../../src/core/renderingpass/frameplanner.hpp#L116) | [`parseFrameGraphDefinitionsFromConfigJson()`](../../src/core/renderingpass/frameplanner.cpp#L1605) | node declarations と既知 resource |
| `FramePlan` | planner output | [`frameplanner.hpp`](../../src/core/renderingpass/frameplanner.hpp#L59) | [`planFrameGraph()`](../../src/core/renderingpass/frameplanner.cpp#L1656) | stable order、levels、RAW barriers |
...
| `FrameGraphResourceContainer` | module/GPU owner | [`computetask.hpp`](../../src/core/renderingpass/computetask.hpp#L74) | [`registerBuffers()`](../../src/core/renderingpass/computetask.cpp#L1830) | named storage buffers と descriptor info |
| `ComputeTaskContainer` | module/runtime registry | [`computetask.hpp`](../../src/core/renderingpass/computetask.hpp#L93) | [`registerComputeTask()`](../../src/core/renderingpass/computetask.cpp#L2375) | compute pipeline、descriptor、dispatch group、barrier |
...
| engine RPC handlers | free registration function | [`runEngineRpcServer()`](../../src/core/communication/rpcserver.cpp#L1837) | 同左 | 43 の protocol method を module/GameContext/編集サービスへ bind |
...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L35) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L108) | central workspace、embedded viewport、7 dock、選択／gizmo model と Outliner / Inspector、frame plan、fullscreen pass JSON 下書き、保存、bounded engine log 表示を所有 |
| `FullscreenPassWidget` | draft-only Qt form | [`fullscreenpasswidget.hpp`](../../src/devstudio/view/fullscreenpasswidget.hpp#L26) | [`fullscreenpasswidget.cpp`](../../src/devstudio/view/fullscreenpasswidget.cpp) | frame-plan resource 候補と read-only 著作宣言から `fullscreen` の部分 JSON、omitted keys、三値の検査軸を表示。project write と engine apply は持たない |
