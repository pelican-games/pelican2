...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `Renderer` | module/orchestrator | [`renderer.hpp`](../../src/core/vkcore/renderer.hpp#L63) | [`renderLogicalFrame()`](../../src/core/vkcore/renderer.cpp#L3859) / [`render()`](../../src/core/vkcore/renderer.cpp#L4740) | hot reload、graph variant、logical frame(multi-view)、trace を束ねる |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `VulkanManageCore` | module/low-level owner | [`core.hpp`](../../src/core/vkcore/core.hpp#L33) | [`constructor`](../../src/core/vkcore/core.cpp#L732) | instance、device、queues、command pools、VMA(Vulkan Memory Allocator — GPU メモリの確保と suballocation を肩代わりする外部ライブラリ) allocation、[`getDebugUtils()`](../../src/core/vkcore/core.hpp#L89) / [`setCurrentFrameIndex()`](../../src/core/vkcore/core.hpp#L109)。XR 時は bootstrap 経由 |
...
| `BufferWrapper` / `ImageWrapper` | RAII value | [`buf.hpp`](../../src/core/vkcore/buf.hpp#L7) / [`image.hpp`](../../src/core/vkcore/image.hpp#L8) | [`VulkanManageCore::allocBuf()`](../../src/core/vkcore/core.cpp#L1060) | Vulkan object と VMA allocation を同居させる |
