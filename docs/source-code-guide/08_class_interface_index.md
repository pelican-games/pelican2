...
| `EditorCommitQueueHook` / `installEditorCommitQueueHook()` | 単一所有フック | [`framephase.hpp#L39`](../../src/core/appflow/framephase.hpp#L39) / [`#L40`](../../src/core/appflow/framephase.hpp#L40) | [`invokeEditorCommitQueueHook()`](../../src/core/appflow/framephase.cpp#L122) | reload 公開後・`freeze_events` 直前に走る編集コミット点。未設置なら zero-state no-op |
...
| `SceneSaveErrorCode` / `SceneSaveError` / `SceneSaveResult` | 保存契約 | [`basicconfig.hpp#L19`](../../src/core/loader/basicconfig.hpp#L19) / [`#L25`](../../src/core/loader/basicconfig.hpp#L25) / [`#L48`](../../src/core/loader/basicconfig.hpp#L48) | [`saveSceneDocument()`](../../src/core/loader/basicconfig.cpp#L693) | `ExternalModification` / `Unavailable` / `IoFailure` の型付き保存エラー |
...
| 名前 | 形 | 宣言 | 主実装 | 責務 |
|---|---|---|---|---|
| `Renderer` | module/orchestrator | [`renderer.hpp`](../../src/core/vkcore/renderer.hpp#L47) | [`renderLogicalFrame()`](../../src/core/vkcore/renderer.cpp#L3668) / [`render()`](../../src/core/vkcore/renderer.cpp#L4472) | hot reload、graph variant、logical frame(multi-view)、trace を束ねる |
