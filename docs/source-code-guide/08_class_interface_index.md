...
| `EngineLaunchConfig` | module | [`launchconfig.hpp`](../../src/core/launchconfig.hpp#L19) | [`player main` で設定](../../src/player/main.cpp#L448) | headless、RPC、XR mode、game logic DLL、record/replay など起動時値 |
...
| `MaterialContainer` | module/GPU owner | [`materialcontainer.hpp`](../../src/core/material/materialcontainer.hpp#L34) | [`registerMaterial()`](../../src/core/material/materialcontainer.cpp#L1889) | texture、material descriptor/pipeline、push constants |
...
| `MainWindow` | Qt Widgets shell | [`mainwindow.hpp`](../../src/devstudio/view/mainwindow.hpp#L19) | [`MainWindow::MainWindow()`](../../src/devstudio/view/mainwindow.cpp#L69) | central workspace、embedded viewport、4 dock、panel/layout menu を所有 |
| `EmbeddedViewport` | Qt viewport panel | [`embeddedviewport.hpp`](../../src/devstudio/viewport/embeddedviewport.hpp#L15) | [`embeddedviewport.cpp`](../../src/devstudio/viewport/embeddedviewport.cpp) | player lifecycle、window discovery、resize/focus、crash/restart UI を所有 |
| `EngineProcess` | Qt child-process owner | [`EngineProcess`](../../src/devstudio/viewport/engineprocess.hpp#L16) | [`engineprocess.cpp`](../../src/devstudio/viewport/engineprocess.cpp) | `pelican_player` の非同期起動、出力、終了監視。renderer へはリンクしない |
| `NativeWindowHost` | Win32 foreign-window adapter | [`NativeWindowHost`](../../src/devstudio/viewport/nativewindowhost.hpp#L24) | [`nativewindowhost.cpp`](../../src/devstudio/viewport/nativewindowhost.cpp) | HWND の style/parent/physical extent/focus/diagnostics だけを担当 |
