...
| [`renderingpass/`](../../src/core/renderingpass) | 描画宣言のパース、検証、frame graph、compute task、RT | [`PassDefinition`](../../src/core/renderingpass/renderingpass.hpp#L432)、[`FramePlan`](../../src/core/renderingpass/frameplanner.hpp#L153) |
