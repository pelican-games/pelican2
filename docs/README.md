...
| `design_editor_tooling.md` | v2.5・共通 authoring/editor 基盤 + 汎用 gizmo feature/RPC + Studio 操作を実装済み(WP149〜172/WP274/275) | typed RPC/service、transaction、undo/save/snapshot/watch/preview。WebSocket は未 |
