...
#ifdef PELICAN_COMPACT_STANDARD_VERTEX_ABI
...
#ifndef PELICAN_COMPACT_STANDARD_VERTEX_ABI
layout(location = 6) in vec4 inCustom0;
layout(location = 7) in vec4 inCustom1;
#endif

#ifdef PELICAN_CUSTOM_MATERIAL_OUTPUTS_V1
// Declarations are generated by the selected material pass schema.
#elif defined(PELICAN_PASS_FORWARD)
...
void main() {
...
#endif
#ifdef PELICAN_CUSTOM_MATERIAL_OUTPUTS_V1
    PelicanMaterialOutputsV1 outputs;
    pelican_initialize_material_outputs_v1(
        outputs, input_data, surface, surface.base_color,
        shading_model);
#ifdef PELICAN_HAS_MATERIAL_OUTPUTS_V1
    pelican_material_outputs_v1(input_data, surface, outputs);
#endif
    pelican_store_material_outputs_v1(outputs);
#else
    ...
    PelicanMaterialOutputsV1 outputs;
    pelican_initialize_material_outputs_v1(
        outputs, input_data, surface,
        vec4(lit, surface.base_color.a), 0.0);
#ifdef PELICAN_HAS_MATERIAL_OUTPUTS_V1
    pelican_material_outputs_v1(input_data, surface, outputs);
#endif
    pelican_store_material_outputs_v1(outputs);
