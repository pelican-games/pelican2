...
makeInspectorWidgetPlan(const EditorComponentQueryResult &component) {
    ...
    if (component.generated) return result;
...
struct InspectorPanel::Impl {
        ...
        if (ImGui::CollapsingHeader(title.c_str(), ImGuiTreeNodeFlags_DefaultOpen)) {
            if (component.generated && component.generated_resolved_json) {
                ImGui::TextColored({0.95F, 0.70F, 0.25F, 1.0F},
                                   "Read-only | generated by prefab %s",
                                   component.generated->prefab.c_str());
                drawReadonlyJson("resolved_json",
                                 *component.generated_resolved_json);
                ImGui::TextDisabled("generated id: %s",
                                    component.generated->stable_generated_id.c_str());
                ImGui::PopID();
                return;
            }
    ...
    void drawInspector(bool *open) {
        ...
        if (selected->prefab_instance) {
            ImGui::TextDisabled("prefab: %s | instance: %s | closure %llu | provider %llu",
                                selected->prefab_instance->ref.c_str(),
                                selected->prefab_instance->instance_id.c_str(),
                                static_cast<unsigned long long>(selected->prefab_instance->closure_generation),
                                static_cast<unsigned long long>(selected->prefab_instance->provider_generation));
        }
        ImGui::Separator();
